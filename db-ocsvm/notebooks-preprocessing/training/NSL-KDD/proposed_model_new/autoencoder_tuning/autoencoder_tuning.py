...
# Load test data
test_set_path = "/home/jbct/Projects/thesis/db-ocsvm/data/processed/NSL-KDD/minamax_scaler_new/test_set_unsplit.csv"
                        ...
                        for slope in slopes_to_try:
                            for dropout in dropout_rate:
                                for decay in weight_decay:
                                    ...
                                    current_model_path_plot = (
                                        f"best_models/autoencoder_{param_str}.png"
                                    )
                                    ...
                                    history = train_autoencoderV3(
                                        ...
                                        best_model_train_plot=current_model_path_plot,
                                        verbose=True,
                                    )
                                    ...
                                    f.write(
                                        f"    Training plot saved in: {current_model_path_plot} \n"
                                    )
                                    f.write(
                                        f"    Normal reconstruction loss: {normal_loss:.6f}\n"
                                    )
