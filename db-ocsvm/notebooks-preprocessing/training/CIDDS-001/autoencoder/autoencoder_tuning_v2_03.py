...
train_df = train_df.drop(columns=["attack_binary", "attack_categorical"])
                    ...
                    for act_type in activation_type:
                        ...
                        for slope in slopes_to_try:
                            for decay in weight_decay:
                                ...
                                current_parameter_combination = f"{lr}_{batch_size}_{optimizer_name}_{act_type}_{slope}_{decay}"
                                if (
