...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run OCSVM inference pipeline.")
    parser.add_argument(
    ...
    parser.add_argument(
        "--ocsvm_onnx_path",
        type=str,
        default="./base_ocsvm_cidds_001.onnx",
    ...
    autoencoder_onnx_path = args.autoencoder_onnx_path
    ocsvm_onnx_path = args.ocsvm_onnx_path
